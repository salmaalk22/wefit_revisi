  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
      <ul class="navbar-nav mx-auto">
        <li class="nav-item">
          <button class="nav-link-btn" onclick="location.href='/admin/users'">Users</button>
        </li>
        <li class="nav-item">
          <button class="nav-link-btn" onclick="location.href='/admin/exercise'">Exercise</button>
        </li>
        <li class="nav-item">
